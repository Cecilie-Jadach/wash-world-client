                ...
                <div onClick={() => setShowModal(false)}
                    ...
                    <div onClick={(e) => e.stopPropagation()} className="bg-white border border-black p-sm grid gap-xs">
                        ...
                        <div className="flex gap-2xs">
                            <Button className="grow" onClick={() => setShowModal(false)} icon={false} variant="secondary">Annuller</Button>
                            <Button className="grow" onClick={handleUpdate} icon={false} variant="dark">Ja, skift medlemskab</Button>
                        </div>
                    </div>
